    ...
    <div class="container-fluid">
        <div class="">
            <div class="mx-auto" style="max-width:1200px">
                <h1 style="color:#555555; text-align:center; font-size:1.8em; padding:24px 0px; font-weight:bold;">管理者削除</h1>
                <div class="">
                    ...
                    <div class="mycart_box">
                        ...
                        <button type="button" onclick="location.href='/admin/index'" class="mt-8 px-2 py-1 bg-blue-400 text-white font-semibold rounded hover:bg-blue-500">管理者
                            ページへ戻る</button>
                    </div>
                </div>
            </div>
