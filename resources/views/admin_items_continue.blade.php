                ...
                <div class="">
                    <div class="flex">
                        ...
                        <div class="mycart_box">
                            ...
                            <button type="button" onclick="location.href='/admin/items/create'" class="px-2 py-1 bg-blue-400 text-white font-semibold rounded hover:bg-yellow-500">引き続き登録する</button>
